-- Update RPCs to maintain account balances when transactions are
-- added, edited, or deleted.  Also adds a one-time recalculation
-- of all existing account balances from transaction history.

-- ============================================================
-- 1. add_transaction_with_splits  (now updates account balance)
-- ============================================================
...
begin
  ...
  -- Verify all supplied category_ids belong to the calling user
  if exists (
...
-- ============================================================
-- 2. update_transaction_with_splits  (now reverses old + applies new balance)
-- ============================================================
...
-- ============================================================
-- 3. delete_transaction_with_balance  (new RPC)
-- ============================================================
...
begin
  ...
  -- Delete transaction (cascades to splits and categories)
...
-- ============================================================
-- 4. One-time balance recalculation from transaction history
-- ============================================================
