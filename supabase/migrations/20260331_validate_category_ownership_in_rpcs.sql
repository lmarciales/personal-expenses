-- Validate that all p_category_ids belong to the calling user inside
-- security definer RPCs. Without this check, a tampered client could
-- pass category UUIDs owned by another user, bypassing RLS since these
